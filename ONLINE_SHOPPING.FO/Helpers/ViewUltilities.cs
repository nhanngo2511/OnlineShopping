...
namespace ONLINE_SHOPPING.FO.Helpers
{
    public static class ViewUltilities
    {
        ...
        public static string FormatMoneytoVND(float OldMoney)
        {
        ...
        public static string FormatMoneytoUSD(float OldMoney)
        {
            string result;
            result = (OldMoney != 0) ? String.Format("{0:,0 USD}", OldMoney) : String.Format("{0:c USD}", OldMoney);
